...
\begin{itemize}
    \item \textbf{Feature count}: total number of features across all tiles\footnote{Contrairy to na"ive reasoning, eatures appearing in multiple tiles at different zoom levels are counted multipe times, as the optimiser reasons per-tile, not per-geographic-entity}.

...
Tremmel et al.~\cite{tremmelMapLibreTileNext2025b} introduced the MapLibre Tile (MLT) format, a columnar alternative that achieves \qtyrange{2}{6}{\times} tile size reduction over MVT.

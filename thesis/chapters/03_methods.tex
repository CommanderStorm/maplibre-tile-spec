...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        \node[data, below=2cm of v8] (proto) {Protobuf\\{\scriptsize (\acs{MVT})}};
        ...
        % tangled nodes
        \node[opt, below=2cm of serial] (opt) {Optimiser};
        \node[test, below right=0.4cm and 1cm of serial] (test) {Render tests};

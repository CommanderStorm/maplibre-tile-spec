...
\begin{figure}[tbph]
	...
	\caption{Heatmap of how jank frames, i.e. frames times that are much slower than the sorrounding frame times, happen. Due to the increased FPS, smaller variations make this metric go up as FPS is higher. this does not nessarily have an effect to the user, since real devices render below the 2000FPS marker that we run at, but nevertheless something to keep in mind.}

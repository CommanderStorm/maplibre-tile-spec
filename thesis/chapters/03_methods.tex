    ...
    \begin{subfigure}[t]{0.38\linewidth}
        ...
        \begin{tikzpicture}[
            ...
            \node[decode, below=of u8, minimum width=3.2cm, align=left]     (name)
                {\texttt{enum <Name> \{}\\[1pt]\quad\scriptsize\texttt{Raw*,}\\[0pt]\quad\scriptsize\texttt{Parsed*,}\\[1pt]\texttt{\}}};
            \node[decode, below=of name]   (tile)   {Tile*};

            \draw[arrow] (u8)   -- node[right, lbl, align=left] {zero-copy parse;\\columns decoded lazily} (name);

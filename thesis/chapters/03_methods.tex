...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        \draw[validation] (corpus) -- node[red,below, label] {validate} (serial);
        \draw[validation] (serial) -- node[right, validationlabel] {validate} (test);
        \draw[validation] (test) -- node[red,right, validationlabel] {validate} (opt);
    \end{tikzpicture}

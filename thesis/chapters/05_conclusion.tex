...
\begin{enumerate}
    ...
    Some passes, such as the default removal passes had both positive and negative effects on the metrics measured, but not to an significant enough extent that pareto optimality would be a significant factor.

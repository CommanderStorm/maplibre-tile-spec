...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.45\linewidth}
        ...
        \begin{tikzpicture}[
            ...
            \node[dec, align=center] at (3.5, -1.4) (decnode)
            ...
            % Decoder arrows: from <Name> top (offset right) up to Decoder,
            % from Decoder down to <Name> bottom (offset right)
            \draw[-Stealth, thick, densely dashed]
                ($(name.north)+(0.6,0)$) |- (decnode.west);
            \draw[-Stealth, thick, densely dashed]
                (decnode.west |- name.south) -- ($(name.south)+(0.6,0)$);
        \end{tikzpicture}

...
\begin{itemize}
    ...
    \noindent\texttt{CollisionIndex}, so merging symbol layers would alter label suppression order; the detailed argument is given alongside the structural passes (\cref{sub:structural_optimizations}).

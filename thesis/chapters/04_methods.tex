...
\begin{figure}[htbp]
	...
	\begin{subfigure}[t]{0.48\linewidth}
		...
		\textbf{Before (distributive factoring + \texttt{any}$\to$\texttt{in})}
		...
		\caption{Expression rewriting via distributive factoring.}
		\label{fig:expr_a}
	...
	\begin{subfigure}[t]{0.48\linewidth}
		...
		\textbf{Before (filter-to-property propagation)}
	...
	\caption{Two expression-level transformations.
		(a) distributive factoring introduces an \texttt{in} expression.
		(b) filter constraints enable constant propagation in styling.}

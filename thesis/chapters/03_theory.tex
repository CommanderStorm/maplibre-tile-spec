...
\begin{wrapfigure}{r}{0.52\textwidth}
    ...
    \begin{tikzpicture}[
        ...
        renderer/.style={box, fill=green!10, minimum width=5.5cm, minimum height=0.7cm},
        server/.style={box, fill=blue!12, minimum width=5.5cm, minimum height=0.7cm},
        datasource/.style={box, fill=orange!10, minimum width=5.5cm, minimum height=0.7cm},
        ...
        \draw[decorate, decoration={brace, amplitude=6pt}, thick]
            ...
            node[midway, right=10pt, font=\scriptsize\itshape] {over\\the\\network};

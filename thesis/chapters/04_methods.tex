...
\begin{figure}[H]
    ...
    \end{tikzpicture}}
    \caption{Layer merging example.  Three adjacent line layers differing only in filter literal, color, and width are merged via the \texttt{match} pattern (Phase~2).

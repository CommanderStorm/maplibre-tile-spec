...
During the typed structural phase, equality constraints are extracted from a layer's filter expression (e.g.\ if the filter asserts \texttt{["==",~["get",~"class"],\ldots]}, then the property \texttt{class} is known to equal \texttt{"primary"} for all features passing the filter).

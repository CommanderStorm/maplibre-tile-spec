...
In some cases, parts of these resources may be generated dynamically - for example, to support complex text shaping for Arabic, Hebrew, Indic, or Japanese scripts as described by Wipfli~\cite{ComplexTextPlugin} for MapLibre or Lengyel~\cite{ADecadeOfSlug} for SLUG.
...
A range of algorithms exist for approximating the Pareto front~\cite{debFastElitistMultiobjective2002,zitzlerIndicatorBasedSelection2004,qingfuzhangMOEAMultiobjectiveEvolutionary2007}.

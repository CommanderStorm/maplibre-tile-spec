...
\begin{description}
    ...
    We therefore quantify the size reductions achievable \emph{without} touching geometry, understating the headroom that composition with an upstream simplifier could reach.

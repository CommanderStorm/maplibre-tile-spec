...
The choice is usually binary per style (given most styles only have one vector source), and the operational question is which styles belong in which group.

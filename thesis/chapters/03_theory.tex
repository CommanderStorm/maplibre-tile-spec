...
A filter \texttt{["all", ["all", a, b], c]} is flattened to \texttt{["all", a, b, c]} by the associativity of conjunctio.
A filter \texttt{["all", true, x]} is simplified to~\texttt{x} by identity elimination.

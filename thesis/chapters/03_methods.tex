...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.45\linewidth}
        ...
        \begin{tikzpicture}[
            ...
            \node[dec, align=center] at (3.5, -3.5) (decnode)
                {Decoder\\{\scriptsize reusable buffers,}\\{\scriptsize memory budget}};
            \draw[-Stealth, thick, densely dashed] (name.north) -| (decnode.north);
            \draw[-Stealth, thick, densely dashed] (decnode.south) |- (name.south);

...
/**
 * {@snippet lang=c :
 * struct MltLayerEncoder_new_result {
 *     union {
 *         MltLayerEncoder *ok;
 *         MltError *err;
 *     };
 ...
 * }
 */
public class MltLayerEncoder_new_result {

  MltLayerEncoder_new_result() {
  ...
  private static final GroupLayout $LAYOUT =
      MemoryLayout.structLayout(
          ...
          .withName("MltLayerEncoder_new_result");
  ...
  private static final AddressLayout ok$LAYOUT =
      (AddressLayout) $LAYOUT.select(groupElement("$anon$22:44"), groupElement("ok"));
  ...
  private static final long ok$OFFSET =
      $LAYOUT.byteOffset(groupElement("$anon$22:44"), groupElement("ok"));
  ...
  private static final AddressLayout err$LAYOUT =
      (AddressLayout) $LAYOUT.select(groupElement("$anon$22:44"), groupElement("err"));
  ...
  private static final long err$OFFSET =
      $LAYOUT.byteOffset(groupElement("$anon$22:44"), groupElement("err"));

...
We keep the legacy self-contained Java encoder in \texttt{java/mlt-core}~\cite{tremmelMapLibreTileNext2025b} only as a reference baseline for the \ac{MLT} experiments in \cref{ch:experiments}; it is not a target of the optimizations proposed in this thesis.

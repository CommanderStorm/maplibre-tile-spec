...
Our layer-merging pass (\cref{sub:structural_optimizations}) attacks the same declarative-rule-merging-under-ordering-constraints problem, but heuristically, since the per-tileset build budget rules don't need a SAT solver.

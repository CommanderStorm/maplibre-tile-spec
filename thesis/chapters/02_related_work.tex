...
The transformations we develop in \cref{ch:methods} that compute a tile pruning advisory from the style and apply it to the tile data are a form of \emph{projection pushdown}~\cite{graefeQueryEvaluationTechniques1993}.
...
Notably, no existing open-source tool or published resarch performs \emph{systematic composition} of style and data optimisations.

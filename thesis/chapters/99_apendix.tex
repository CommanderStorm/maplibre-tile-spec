...
\Cref{fig:app_animation_patterns} visualises each used animation pattern.
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.31\linewidth}
        ...
        \begin{tikzpicture}
            ...
            \node[axislabel] at (\mapcx, -0.15) {lng};
            \node[axislabel, rotate=90] at (-0.25, \mapcy) {lat};
            \foreach \i/\nx/\ny in {%
            ...
            \foreach \i/\h in {0/0.232, 1/0.308, 2/0.232, 3/0.308, 4/0.232, 5/0.308, 6/0.232, 7/0.308} {
                \pgfmathsetmacro{\bx}{\stripx + \i*0.3125 + 0.045}
                \draw[bar] (\bx, \zstripy+0.04) rectangle (\bx+0.22, \zstripy+\h);
            }
            \node[striplabel, anchor=south west] at (\stripx+\stripw+0.04, \zstripy+0.308) {14};
            \node[striplabel, anchor=north west] at (\stripx+\stripw+0.04, \zstripy+0.232) {10};

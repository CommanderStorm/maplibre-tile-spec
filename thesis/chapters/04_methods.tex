...
The generated types include serialisation and deserialisation support, so the structural passes can round-trip tested.
...
The codegen pipeline corresponds to the top row of \cref{fig:system_architecture}.

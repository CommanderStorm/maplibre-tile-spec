...
The prior Java encoder groups columns by naming prefix (e.g., \texttt{\mlval{name}}, \texttt{\mlval{name:en}}, \texttt{\mlval{name:de}}), which misses semantic overlaps (e.g., \texttt{\mlval{class}} and \texttt{\mlval{subclass}} in OpenMapTiles share many values).

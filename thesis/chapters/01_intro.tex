...
To answer these questions, we design and implement a standalone optimizer that consumes \ac{MVT}s and optional tile-level statistics, and produces a equivalent (\cref{eq:visual_equivalence}) style whose rendering performance and network utilsation is measurably improved.

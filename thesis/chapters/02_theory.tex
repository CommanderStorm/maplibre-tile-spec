...
\begin{itemize}
    ...
    It uses \acp{PBF}~\cite{ProtocolBuffers} as its wire format and stores features in a \emph{row-oriented} layout: each feature carries its own list of property tags encoded as alternating key and value indices into per-layer string and value tables.

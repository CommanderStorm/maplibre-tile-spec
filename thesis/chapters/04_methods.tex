...
With the optimiser pipeline, its individual passes, and the evaluation methodology now defined, in the following chapter we apply this methodology to evaluate each optimisation category - expression-level, structural, and data-level - and then analyse their combined effect across the full benchmark corpus.

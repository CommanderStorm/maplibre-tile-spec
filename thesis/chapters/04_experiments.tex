...
BasemapDE styles that reference \texttt{funktion} and \texttt{objart} columns absent from OpenMapTiles would produce different shaving advisories and potentially different cascade magnitudes.

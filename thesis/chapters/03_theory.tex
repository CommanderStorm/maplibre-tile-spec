...
The following chapter (\cref{sec:problem_statement}) formalises the joint optimization problem and turns these foundations into concrete passes and an evaluation methodology.
\end{chaptersummary}

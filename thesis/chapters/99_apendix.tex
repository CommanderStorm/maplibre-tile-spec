...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.31\linewidth}
        ...
        \caption{\textbf{Zoomdrill.} Maximises tile-cache churn and LOD switching.}
    ...
    \begin{subfigure}[t]{0.31\linewidth}
        ...
        \caption{\textbf{Pansweep.} Drives sustained unidirectional tile cache misses in isolation.}

...
For the geospatial community this means that style authoring and tile encoding can be treated as colinear concerns: the two interact, and tooling that exploits the interaction can recover substantial transfer and rendering savings without any change to the underlying data or the renderer.

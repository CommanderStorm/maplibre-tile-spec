...
The experiments in the preceding chapter evaluated each optimisation level in isolation and then measured their combined effect, revealing that the cascade from style simplification through tile shaving to columnar re-encoding is strictly more effective than the sum of its parts.

...
\cref{ch:experiments} quantifies the payoff - \textbf{load times down by up to \qty{75}{\percent} and tile volume by \qty{28}{\percent}} on the styles we benchmarked end-to-end - and the OGC API-Tiles standard~\cite{OGCAPITiles} keeps these gains deployable without vendor lock-in.

...
This empirically confirms that the trial-and-retain loop costs $k$ encode passes plus $O(1)$ bookkeeping rather than $k$ encode passes plus $k$ full buffer clones.

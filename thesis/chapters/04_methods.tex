...
Both halves are exercised on the style level by the round-trip proptest and on the tile level by the libFuzzer harness of \cref{par:encoder_validation}.
...
For example, a fill layer whose \mlprop{fill-opacity} is a step function that outputs~0 below zoom~12 and~1 above is effectively invisible below zoom~12. The pass therefore raises \mlprop{minzoom} to~12.

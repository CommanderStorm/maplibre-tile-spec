...
\subsection{Building Optimisations}\label{sec:building_optimisations}
...
\subsubsection{Expression-Level Optimisations}\label{sub:expression_optimisations}
...
\subsubsection{Structural Optimisations}\label{sub:structural_optimisations}
...
\subsubsection{Data-Level Optimisations}\label{sub:data_optimisations}

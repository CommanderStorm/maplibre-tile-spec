...
\Cref{ch:methods} develops the style-driven tile pipeline in this vocabulary.
...
\Cref{ch:methods} positions the expression-level pass against these two reference points.
...
\cref{ch:experiments} quantifies the payoff on the styles we benchmarked end-to-end, and the \ac{OGC} API-Tiles standard~\cite{OGCAPITiles} keeps these gains deployable without vendor lock-in.

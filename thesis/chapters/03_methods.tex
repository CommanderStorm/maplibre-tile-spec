...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.45\linewidth}
        ...
        \begin{tikzpicture}[
            ...
            \node[dec, right=1.5cm of $(u8)!0.5!(name)$] (decnode) {Decoder};

            % Phantom node to balance bounding box so pipeline stays centred
            \path let \p1=(decnode.east), \p2=(name.center) in
                node[inner sep=0pt, minimum width=0pt] at (2*\x2-\x1, 0) {};
            ...
            \draw[-{Stealth[length=2.5mm]}, thick, densely dashed]
                (u8.east) -| (decnode.north);
            \draw[-{Stealth[length=2.5mm]}, thick, densely dashed]
                (decnode.south) |- (name.east);
        \end{tikzpicture}

...
Given an input pair $(S, T)$ and a cost function $c: \mathcal{S} \times \mathcal{T} \to \mathbb{R}_{[0,1]}$, find $(S', T')$ minimizing $c(S', T')$ subject to the \emph{visual equivalence} constraint where $\equiv$ denotes pixel-identity under a deterministic rasteriser:

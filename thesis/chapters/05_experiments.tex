...
\caption{Per-style summary: baseline and optimised style size (gzip), percentage reduction, and change in load time and FPS (median across scenarios). Styles below the rule include tile-level optimisations (steps~1-19) while above only include  (steps~1-15)}

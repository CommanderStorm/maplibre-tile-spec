...
/**
 * {@snippet lang=c :
 * struct MltLayerEncoder_encode_result {
 *     union {
 *         MltEncodedBuffer *ok;
 *         MltError *err;
 *     };
 ...
 * }
 */
public class MltLayerEncoder_encode_result {

  MltLayerEncoder_encode_result() {
  ...
  private static final GroupLayout $LAYOUT =
      MemoryLayout.structLayout(
          ...
          .withName("MltLayerEncoder_encode_result");
  ...
  private static final AddressLayout ok$LAYOUT =
      (AddressLayout) $LAYOUT.select(groupElement("$anon$37:47"), groupElement("ok"));
  ...
  private static final long ok$OFFSET =
      $LAYOUT.byteOffset(groupElement("$anon$37:47"), groupElement("ok"));
  ...
  private static final AddressLayout err$LAYOUT =
      (AddressLayout) $LAYOUT.select(groupElement("$anon$37:47"), groupElement("err"));
  ...
  private static final long err$OFFSET =
      $LAYOUT.byteOffset(groupElement("$anon$37:47"), groupElement("err"));

...
\begin{figure}[htbp]
    ...
    \resizebox{\linewidth}{!}{\hfuzz=50pt\begin{tikzpicture}[
        ...
        % ── Input layers (left) ──
        \node[layer, fill=red!12]   (l0) {line: \texttt{class == "motorway"}\\\texttt{line-color: \#e892a2}\\\texttt{line-width: 3}};
        \node[layer, fill=orange!12, below=of l0] (l1) {line: \texttt{class == "primary"}\\\texttt{line-color: \#fcd6a4}\\\texttt{line-width: 2}};
        \node[layer, fill=yellow!15, below=of l1] (l2) {line: \texttt{class == "secondary"}\\\texttt{line-color: \#f7fabf}\\\texttt{line-width: 1.5}};

...
/**
 * {@snippet lang=c :
 * struct MltTileEncoder_add_layer_result {
 *     union {
 *         MltError *err;
 *     };
 *     _Bool is_ok;
 ...
 * }
 */
public class MltTileEncoder_add_layer_result {

  MltTileEncoder_add_layer_result() {
    // Should not be called directly
  }

  private static final GroupLayout $LAYOUT =
      MemoryLayout.structLayout(
              MemoryLayout.unionLayout(mlt_ffi_h.C_POINTER.withName("err")).withName("$anon$24:49"),
              mlt_ffi_h.C_BOOL.withName("is_ok"),
              MemoryLayout.paddingLayout(7))
          .withName("MltTileEncoder_add_layer_result");
  ...
  private static final AddressLayout err$LAYOUT =
      (AddressLayout) $LAYOUT.select(groupElement("$anon$24:49"), groupElement("err"));
  ...
  private static final long err$OFFSET =
      $LAYOUT.byteOffset(groupElement("$anon$24:49"), groupElement("err"));

...
\caption{Per-style summary: baseline and optimised style size (gzip), percentage reduction, and change in load time and FPS (median across scenarios). Styles below the rule include tile-level optimisations (steps~16-19)}

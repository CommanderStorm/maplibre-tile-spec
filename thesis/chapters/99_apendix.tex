...
\cref{tab:maputnik_full} lists the 13 styles from the Maputnik editor catalogue used in the cross-style generalisation study (\cref{sec:exp_cross_style}), together with per-style metrics.

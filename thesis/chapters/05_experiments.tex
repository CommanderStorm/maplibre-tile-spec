...
\begin{figure}[htbp]
    ...
    \caption{Relationship between initial style complexity (layer count) and achievable raw style size reduction across the Maputnik generalization corpus. The correlation is not statistically significant ($r = 0.16$, $n = 13$), indicating that optimization yield is not reliably predictable from layer count alone.}

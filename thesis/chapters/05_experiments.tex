...
\begin{figure}[tbph]
	...
	\caption{Heatmap of how jank frames, i.e. frames times that are much slower than the sorrounding frame times, happen. Due to the increased FPS, smaller variations like \ac{GC}-pauses make this metric go up as FPS is higher.

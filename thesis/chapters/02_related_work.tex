...
The thesis's encoding competition differs from these systems by operating at tile granularity (\qtyrange{10}{100}{\kilo\byte}) rather than on large analytical datasets, and includes application specific optimsations like spatial sort-order dimension (Hilbert, Morton) that database encoders do not consider.

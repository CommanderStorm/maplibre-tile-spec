...
pub(crate) fn parse_stream_meta<'a>(
    ...
    let logical_encoding = match logical {
        ...
        LC::Morton | LC::MortonRle | LC::MortonDelta => {
            ...
            match logical {
                LC::MortonRle => LogicalEncoding::Vertex(VertexLogical::MortonRle(morton)),
                LC::MortonDelta => LogicalEncoding::Vertex(VertexLogical::MortonDelta(morton)),
                _ => LogicalEncoding::Vertex(VertexLogical::Morton(morton)),
            }
        }
    };

...
\begin{figure}[htbp]
    ...
    \resizebox{\linewidth}{!}{\hfuzz=50pt\begin{tikzpicture}[
        ...
        \node[layer, fill=orange!12, below=0.5cm of l0] (l1) {line:\\\texttt{class == "primary"}\\\texttt{line-color: \#fcd6a4}\\\texttt{line-width: 2}};
        \node[layer, fill=yellow!15, below=0.5cm of l1] (l2) {line:\\\texttt{class == "secondary"}\\\texttt{line-color: \#f7fabf}\\\texttt{line-width: 1.5}};
        ...
        \node[right=1.4cm of l1, check, text width=4.2cm] (p2) {%
            ...
            all filters  (\texttt{["==",\,["get",\,"class"],\,L]}) access the same property \texttt{"class"} with unique literals\\

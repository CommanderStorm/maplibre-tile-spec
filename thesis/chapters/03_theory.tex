...
\begin{itemize}
	\item \makebox[3.5cm][l]{\emph{Identity elements}:}
	$\begin{alignedat}{4}
	...
	\item \makebox[3.5cm][l]{\emph{Annihilation}:}
	$\begin{alignedat}{3}
	...
	\item \makebox[3.5cm][l]{\emph{De~Morgan's laws}:}
	$\begin{alignedat}{2}
		\lnot (a \land b) & = \lnot a \lor \lnot b \qquad &
		\lnot (a \lor b)  & = \lnot a \land \lnot b
	\end{alignedat}$.
	
	\item \makebox[3.5cm][l]{\emph{Idempotence}:}
	$\begin{alignedat}{2}
		x \land x & = x \qquad &
		x \lor x  & = x
	\end{alignedat}$.
	
	\item \makebox[3.5cm][l]{\emph{Absorption}:}
	$\begin{alignedat}{2}

...
\begin{figure}[h]
    ...
    \begin{tikzpicture}[
        ...
        \draw[arrow] (s4) -- node[right, label] {style}   (s4 |- renderer.south);
        \draw[arrow] (s3) -- node[right, label] {tiles}   (s3 |- renderer.south);
        \draw[arrow] (s1) -- node[right, label] {sprites} (s1 |- renderer.south);
        \draw[arrow] (s2) -- node[right, label] {fonts}   (s2 |- renderer.south);

...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.45\linewidth}
        ...
        \begin{tikzpicture}[
            ...
            % Phantom to mirror Decoder width so pipeline stays centred
            \path let \p1=(decnode.east), \p2=(name.center) in
                node[inner sep=0pt] at (2*\x2-\x1, 0) {};
    ...
    \begin{subfigure}[t]{0.45\linewidth}
        ...
        \begin{tikzpicture}[
            ...
            % Phantom to mirror *Encoder width so pipeline stays centred
            \path let \p1=(encnode.west), \p2=(staged.center) in
                node[inner sep=0pt] at (2*\x2-\x1, 0) {};

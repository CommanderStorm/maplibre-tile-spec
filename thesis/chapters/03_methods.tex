...
With these theoretical tools in place - the rendering architecture that defines the optimisation target, the compiler and database techniques that supply the rewrite strategies, the encoding schemes that govern the data level, and the formal problem statement that constrains correctness - the following chapter presents the concrete design and implementation of the optimiser.

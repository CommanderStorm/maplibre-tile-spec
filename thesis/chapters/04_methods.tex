...
In the pathological case, this could mean that this results in $|\text{AltSession}|$ \texttt{memcpy} calls, but in practice they are ordered by decending likelyhood.

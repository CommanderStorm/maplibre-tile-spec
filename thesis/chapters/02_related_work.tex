...
Our layer-merging pass (\cref{sub:structural_optimizations}) attacks the same declarative-rule-merging-under-ordering-constraints problem, but heuristically.

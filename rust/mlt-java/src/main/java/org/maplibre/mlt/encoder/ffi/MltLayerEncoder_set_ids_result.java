...
/**
 * {@snippet lang=c :
 * struct MltLayerEncoder_set_ids_result {
 *     union {
 *         MltError *err;
 *     };
 *     _Bool is_ok;
 ...
 * }
 */
public class MltLayerEncoder_set_ids_result {

  MltLayerEncoder_set_ids_result() {
    // Should not be called directly
  }

  private static final GroupLayout $LAYOUT =
      MemoryLayout.structLayout(
              MemoryLayout.unionLayout(mlt_ffi_h.C_POINTER.withName("err")).withName("$anon$25:48"),
              mlt_ffi_h.C_BOOL.withName("is_ok"),
              MemoryLayout.paddingLayout(7))
          .withName("MltLayerEncoder_set_ids_result");
  ...
  private static final AddressLayout err$LAYOUT =
      (AddressLayout) $LAYOUT.select(groupElement("$anon$25:48"), groupElement("err"));
  ...
  private static final long err$OFFSET =
      $LAYOUT.byteOffset(groupElement("$anon$25:48"), groupElement("err"));

...
In practice, we quantify $v$ only over the discrete grid of zooms and viewports, and verify pixel-identity by direct image comparison rather than by proof.

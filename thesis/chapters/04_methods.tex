...
\begin{figure}[htbp]
	...
	\begin{tabular}{p{0.48\linewidth} p{0.48\linewidth}}
		...
		\textbf{Left transformation} & \textbf{Right transformation} \\
	...
	\caption{Two expression-level transformations.
		Left: distributive factoring merges predicates and introduces an \texttt{in} expression.
		Right: constant propagation simplifies a \texttt{match} after filtering.}

...
The motivation is that fewer layers means fewer rendering passes. The renderer processes layers sequentially, and each layer incurs setup costs (binding textures, configuring blend state, submitting draw calls).

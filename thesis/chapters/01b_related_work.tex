...
The introduction identified a gap between how map styles and tile data are prepared today: styles are tuned for visual appearance while tiles are encoded with general-purpose content and compression, and no existing open-source system exploits the interaction between the two.
...
\cref{sec_rw_style_optimizations} examines the limited prior work on style-level optimisation.

...
No existing open-source tool or published research performs \emph{systematic composition} of style and data optimisations - the unified $(S, T) \to (S', T')$ optimisation we formalise in \cref{sec:problem_statement}.

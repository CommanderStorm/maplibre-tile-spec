...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        % tanlged arrows
        \draw[ultra thick,red,->] (corpus) -- node[red,below, label] {validate} (serial);
        \draw[query] (opt) -- node[right, label] {optimise} (serial);
        \draw[query] (scan) -- node[above, near start, label] {statistics} (opt);
        \draw[ultra thick,red,->] (serial) -- node[right, label] {[text=red]validate} (test);
        \draw[ultra thick,red,->] (test) -- node[red,right, label] {[text=red]validate} (opt);
    \end{tikzpicture}

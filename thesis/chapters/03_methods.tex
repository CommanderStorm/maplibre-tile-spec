...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.45\linewidth}
        ...
        \begin{tikzpicture}[
            ...
            \node[dec, right=2cm of $(u8)!0.5!(name)$] (decnode) {Decoder};
            ...
            \draw[-Stealth, thick, densely dashed] (decnode.south) -- ($(name.east)+(0.25,0)$) -- (name.east);
        \end{tikzpicture}
    ...
    \begin{subfigure}[t]{0.45\linewidth}
        ...
        \begin{tikzpicture}[
            ...
            \draw[-{Stealth[length=2.5mm]}, thick, densely dashed]
                (staged.west) -- ++(-0.25,0) |- (encnode.south);
            \draw[-{Stealth[length=2.5mm]}, thick, densely dashed]
                (encnode.north) -| ($(encoded.west)+(-0.25,0)$) -- (encoded.west);
        \end{tikzpicture}

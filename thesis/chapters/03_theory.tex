...
\Cref{lst:worker_pipeline} shows the worker's tile-parse pipeline as five named steps, marked inline as \stepcirc{a} to \stepcirc{e}.
...
\begin{itemize}
	...
	\item \emph{Integer Annihilation} (can only be applied to integers because of \texttt{NaN}):
	\[
	\begin{alignedat}{1}
		x \cdot 0               & = 0
	\end{alignedat}
...
A filter \texttt{["all", ["all", a, b], c]} is flattened to \texttt{["all", a, b, c]} by associativity.

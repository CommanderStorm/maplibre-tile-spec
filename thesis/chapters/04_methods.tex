...
\begin{equation}\label{eq:selectivity_compound}
    \begin{aligned}
        \mathrm{sel}(\texttt{all expr} expr) &= \prod_i \mathrm{sel}(p_i) \\[4pt]
        \mathrm{sel}(\texttt{any expr}) &= 1 - \prod_i \bigl(1 - \mathrm{sel}(p_i)\bigr) \\[4pt]
    \end{aligned}
\end{equation}
...
\begin{figure}[htbp]
    ...
    \resizebox{\linewidth}{!}{\hfuzz=50pt\begin{tikzpicture}[
        ...
        phase/.style={rectangle, draw, dashed, rounded corners=3pt,
                      inner sep=5pt},
        arrow/.style={-Stealth, thick},
        label/.style={font=\scriptsize\itshape, text=gray},

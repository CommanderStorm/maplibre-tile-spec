...
Tile shaving bridges style-level and data-level optimisations.
...
The encoding competition reformulates the encoding problem as a \emph{multi-strategy competition} inspired by profile-guided optimisations in compilers: rather than committing to a single encoding plan, the encoder tries multiple strategies, measures the output size of each, and selects the smallest.
...
\paragraph{Compression optimisations}
\begin{sloppypar}
